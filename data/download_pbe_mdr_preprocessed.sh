...
wget https://figshare.com/ndownloader/files/60964675 -O data/pbe-mdr/train-aselmdb.tar.gz
wget https://figshare.com/ndownloader/files/60964672 -O data/pbe-mdr/val-aselmdb.tar.gz
wget https://figshare.com/ndownloader/files/60975931 -O data/pbe-mdr/test.tar.gz
